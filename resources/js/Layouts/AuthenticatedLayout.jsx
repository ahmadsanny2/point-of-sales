            ...
            <aside className="hidden w-64 bg-slate-900 flex-col sm:flex transition-all duration-300 shadow-xl">
                ...
                <div className="flex flex-1 flex-col overflow-y-auto px-4 py-6">
                    <nav className="flex-1 space-y-1.5 px-2">
                        ...
                        >
                            <svg className={`w-5 h-5 ${route().current('dashboard') ? 'text-white' : 'text-slate-500 group-hover:text-slate-300'} transition-colors`} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zm10 0a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zm10 0a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z"></path></svg>
                            Dashboard
                        </Link>
                        
                        <div className="pt-5 pb-2 px-3">
                            <p className="text-[11px] font-bold text-slate-500 uppercase tracking-wider">Laporan</p>
                        </div>
                        <Link 
                        ...
                        >
                            <svg className={`w-5 h-5 ${route().current('transactions.*') ? 'text-white' : 'text-slate-500 group-hover:text-slate-300'} transition-colors`} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg>
                            Riwayat Transaksi
                        </Link>

                        <div className="pt-5 pb-2 px-3">
                            <p className="text-[11px] font-bold text-slate-500 uppercase tracking-wider">Operasional</p>
                        </div>
                        <Link 
                        ...
                        >
                            <svg className={`w-5 h-5 ${route().current('pos.*') ? 'text-white' : 'text-blue-400'} transition-colors`} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z"></path></svg>
                            Buka Mesin Kasir
                        </Link>

                        <div className="pt-5 pb-2 px-3">
                            <p className="text-[11px] font-bold text-slate-500 uppercase tracking-wider">Data Master</p>
                        </div>
                        <Link 
                        ...
                        >
                            <svg className={`w-5 h-5 ${route().current('categories.*') ? 'text-white' : 'text-slate-500 group-hover:text-slate-300'} transition-colors`} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 002-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"></path></svg>
                            Kategori Produk
                        </Link>
                        <Link 
                        ...
                        >
                            <svg className={`w-5 h-5 ${route().current('products.*') ? 'text-white' : 'text-slate-500 group-hover:text-slate-300'} transition-colors`} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"></path></svg>
                            Produk
                        </Link>
                    </nav>
                </div>
            ...
            <div className="flex flex-1 flex-col overflow-hidden">
                ...
                <header className="flex h-16 shrink-0 items-center justify-between border-b border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 px-4 sm:px-6 lg:px-8 shadow-sm z-10 transition-colors duration-200">
                    ...
                    <div className="hidden sm:flex flex-1 items-center">
                        <h2 className="text-xl font-semibold leading-tight text-slate-800 dark:text-slate-100 transition-colors">{header}</h2>
                    </div>
                            ...
                            <Dropdown>
                                <Dropdown.Trigger>
                                    <span className="inline-flex rounded-md">
                                        <button type="button" className="inline-flex items-center gap-2 rounded-full border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 px-4 py-2 text-sm font-medium leading-4 text-slate-600 dark:text-slate-300 transition hover:text-slate-800 dark:hover:text-slate-100 hover:shadow-md hover:bg-slate-50 dark:hover:bg-slate-700 focus:outline-none">
                ...
                <div className={(showingNavigationDropdown ? 'block' : 'hidden') + ' sm:hidden bg-slate-900 border-b border-slate-800 text-white relative z-20 shadow-lg'}>
                ...
                <main className="flex-1 overflow-y-auto p-4 sm:p-6 lg:p-8 bg-slate-50 dark:bg-slate-900 transition-colors duration-200">
                    ...
                    <div className="sm:hidden mb-4 pb-2 border-b border-slate-200 dark:border-slate-800">
                         <h2 className="text-xl font-semibold leading-tight text-slate-800 dark:text-slate-100">{header}</h2>
                    </div>
                    {children}
                </main>
            </div>
