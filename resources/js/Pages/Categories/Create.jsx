        ...
        <AuthenticatedLayout header="Tambah Kategori">
            ...
            <div className="max-w-xl mx-auto bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-100 dark:border-slate-700 overflow-hidden transition-colors">
                <div className="px-6 py-4 border-b border-slate-100 dark:border-slate-700 flex items-center bg-slate-50 dark:bg-slate-900/50 transition-colors">
                    ...
                    <h3 className="text-lg font-medium text-slate-800 dark:text-slate-100">Detail Kategori</h3>
                </div>
                ...
                <form onSubmit={submit} className="p-6">
                    <div className="mb-6">
                        ...
                        <input
                            id="name"
                            type="text"
                            className={`w-full rounded-md border ${errors.name ? 'border-red-300 focus:border-red-500 focus:ring-red-500' : 'border-slate-300 dark:border-slate-600 focus:border-blue-500 focus:ring-blue-500'} px-3 py-2 text-sm text-slate-900 dark:text-slate-100 bg-white dark:bg-slate-700 placeholder-slate-400 dark:placeholder-slate-500 transition-colors`}
                            value={data.name}
