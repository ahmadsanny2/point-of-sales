 ...
 */
export default function Index({ categories, products, cart_items, midtrans_client_key, is_production }) {
    const pos = usePosLogic({ products, cart_items, midtrans_client_key, is_production });
